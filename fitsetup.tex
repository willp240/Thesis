...
\textbf{2p2h Norm $\bar{\nu}$} & 2p2h, $\bar{\nu}$ & 1.0 & 1.0 & Flat & Norm.\\
\hline
\textbf{2p2h Norm C to O} & 2p2h on O & 1.0 & 0.2 & Gaus & Norm.\\
\hline
\textbf{2p2h Shape C} & 2p2h on C & 1.0 & 3.0 & Gaus & Shape\\
\hline
\textbf{2p2h Shape O} & 2p2h on O & 1.0 & 3.0 & Gaus & Shape\\
\hline
...
\hline
\textbf{CC coh C} & CC Coherent on C & 1.0 & 0.3 & Gaus & Norm.\\
\hline
\textbf{CC coh O} & CC Coherent on O & 1.0 & 0.3 &  Gaus & Norm.\\
\hline
...
All of these one-time corrections (apart from the Coulomb shifts and $E_{b}$ parameters), along with the systematics that vary in the fit, are applied as multiplicative weights on an event-by-event basis.
