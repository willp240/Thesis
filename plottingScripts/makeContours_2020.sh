...
then
    ...
    then
	    ...
	    FILENAME="/vols/build/t2k/wparker2/MaCh3_2020NewSplines/MaCh3/reduced_15Apr2020_AsimovA-TH2D_noBurnin.root"
	    CONTOURDIR=contours_AsimovA_th2d
	    burnin=120000
	    #burnin=0
	    #WORC Run 1-7C 1D dcp flat prior in sindcp limits obtain from contours_app1D with (file,0,true,true) as arguments
	    leftarr68=-0.15
...
root -l -q -b 'utils/contours.C+("'$FILENAME'",'$trueth23','$truedm23',-999,0,'${burnin}','$wrc')'
...
root -l -q -b 'utils/contours.C+("'$FILENAME'",0,0,-999,1,'${burnin}','$wrc')'
...
echo "  BOTH HIERARCHIES:"
root -l -q -b 'utils/contours_app.C+("'$FILENAME'",'$trueth13','$truedcp',-999,0,'${burnin}','$wrc')'
...
echo "  NORMAL HIERARCHY:"
root -l -q -b 'utils/contours_app.C+("'$FILENAME'",'$trueth13','$truedcp',-999,1,'${burnin}','$wrc')'
...
root -l -q -b 'utils/contours_app1D.C+("'$FILENAME'",0,'${burnin}',false,false)'
...
echo "  NORMAL HIERARCHY:"
root -l -q -b 'utils/contours_app1D.C+("'$FILENAME'",1,'${burnin}',false,false)'
...
# LogY axis version:
root -l -q -b 'utils/contours_app1D.C+("'$FILENAME'",0,'${burnin}',false,true)'
...
echo "  NORMAL HIERARCHY:"
root -l -q -b 'utils/contours_app1D.C+("'$FILENAME'",1,'${burnin}',false,true)'
...
echo "  BOTH HIERARCHIES:"
#get 1D appearance contours
root -l -q -b 'utils/contours_1D.C+("'$FILENAME'",0,'${burnin}')'
...
echo "  NORMAL HIERARCHY:"
#get 1D appearance contours
root -l -q -b 'utils/contours_1D.C+("'$FILENAME'",1,'${burnin}')'
