#!/bin/bash
OUTFOLDER=compMaCh3Contours_TH2DvsTHPoly_asimov
OUTNAMEBASE="compMaCh3Contours_TH2DvsTHPoly"
rm -rf $OUTFOLDER
mkdir $OUTFOLDER
OUTNAME="$OUTFOLDER/$OUTNAMEBASE"

CONTOURFOLDER2020="/vols/build/t2k/wparker2/MaCh3_2020NewSplines/MaCh3/contours_AsimovA_poly"
CONTOURFOLDER2018="/vols/build/t2k/wparker2/MaCh3_2020NewSplines/MaCh3/contours_AsimovA_th2d"
...
root -l -b -q 'utils/CompareContours.C("'$CONTOURFILE2018NH'","'$CONTOURFILE2020NH'","Uniform ND Fit Bins","Non-Uniform ND Fit Bins",false,"'$OUTNAME'_disapp_asimovA_NH",false,false,false)'
root -l -b -q 'utils/CompareContours.C("'$CONTOURFILE2018IH'","'$CONTOURFILE2020IH'","Uniform ND Fit Bins","Non-Uniform ND Fit Bins",false,"'$OUTNAME'_disapp_asimovA_IH",false,true,false)'
...
root -l -b -q 'utils/CompareContours.C("'$CONTOURFILE2018APPNH'","'$CONTOURFILE2020APPNH'","Uniform ND Fit Bins","Non-Uniform ND Fit Bins",true,"'$OUTNAME'_app_asimovA_NH",false,false,false)'
root -l -b -q 'utils/CompareContours.C("'$CONTOURFILE2018APPIH'","'$CONTOURFILE2020APPIH'","Uniform ND Fit Bins","Non-Uniform ND Fit Bins",true,"'$OUTNAME'_app_asimovA_IH",false,true,false)'
...
root -l -b -q 'utils/CompareContours1Ddcp.C("'$CONTOURFILE2018DCPNH'","'$CONTOURFILE2020DCPNH'","Uniform ND Fit Bins","Non-Uniform ND Fit Bins","'$OUTNAME'_dcp_asimovA_NH")'
root -l -b -q 'utils/CompareContours1Ddcp.C("'$CONTOURFILE2018DCPIH'","'$CONTOURFILE2020DCPIH'","Uniform ND Fit Bins","Non-Uniform ND Fit Bins","'$OUTNAME'_dcp_asimovA_IH")'
