...
void contours_app1D_EB(TString fs,int onehierarchyonly=0,int burnIn=0, bool doRCrw=false, bool doLogY = false, bool axisX_sindcp = false, bool prior_sindcp = false)
{
  ...
  double tth13, tth23, tdcp, tdm32, tbiaswgt = 1.0, xsec_20;
  double RCrw = 1.0;
  int stp;
