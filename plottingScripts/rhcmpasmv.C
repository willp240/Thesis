...
void rhcmpasmv(std::string FileName1, std::string Name1, std::string FileName2, std::string Name2) {
  ...
  for (int i = 0; i < nFluxPlots; ++i) {
    ...
    //canv->Print((FileName1+FileName2+".pdf").c_str());
    canv->Print(("rhcmpasmvflux"+fluxnum+".pdf").c_str());
  ...
  for (int i = 1; i < XsecPlots; ++i) {
    ...
    //canv->Print((FileName1+FileName2+".pdf").c_str());
    canv->Print(("rhcmpasmvxsec"+xsecnum+".pdf").c_str());
