...
\begin{subfigure}{0.24\textwidth}
  ...
  \caption{SK RHC $\bar{\nu_e}$}
\end{subfigure}
\caption{Flux parameters for the data fit using FHC only data.}
...
\begin{subfigure}{0.24\textwidth}
  ...
  \caption{SK RHC $\bar{\nu_e}$}
\end{subfigure}
\caption{Flux parameters for the Asimov fit using FHC and RHC data.}
...
\begin{subfigure}{0.24\textwidth}
  ...
  \caption{SK RHC $\bar{\nu_{e}}$}
\end{subfigure}
\caption{Flux parameters for the data fit using FHC and RHC data.}
