...
The $p_{\mu}$ and cos$\theta_{\mu}$ projections of the prior predictive distributions are shown in Figures \ref{fig:priorpost_fhc_p2}-\ref{fig:priorpost_rhc_numu_t2}.
...
\label{fig:priorpost_rhc_numub_p2}
\end{figure}
...
\end{subfigure}
\caption{$p_{\mu}$ projections of the prior predictive distributions and data for RHC \numu selections.}
\label{fig:priorpost_rhc_numu_p2}
\end{figure}
...
\label{fig:priorpost_rhc_numub_t2}
\end{figure}
...
\end{subfigure}
\caption{cos$\theta_{\mu}$ projections of the prior predictive distributions and data for RHC \numu selections.}
\label{fig:priorpost_rhc_numu_t2}
\end{figure}