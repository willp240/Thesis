...
\end{subfigure}
\caption{$p_{\mu}$ projections of data and nominal MC broken down by interaction mode.}
\label{fig:pstack}
\end{figure}
...
\begin{tabular}{S||
                ...
                r}
\hline \hline
\multicolumn{1}{c||}{\textbf{Sample}} & \multicolumn{6}{c|}{\textbf{Event Rates}} & \multicolumn{2}{c}{\textbf{-2LLH$_{Sample}$}}\\
...
\hline \hline
\multicolumn{1}{c||}{\textbf{Sample}} & \multicolumn{6}{c}{\textbf{Event Rates}} \\
& \multicolumn{3}{c}{\textbf{Non-Uniform}} & \multicolumn{3}{c}{\textbf{Non-Uniform}}\\
& \multicolumn{3}{c}{\textbf{Fit Bins}} & \multicolumn{3}{c}{\textbf{Fit and Det. Bins}}\\
\hline
\hline
