...
\textbf{Total} & \multicolumn{2}{c}{0.00}\\ \hline\hline
\end{tabular}
...
%LLH dists say to investigate low pvalue
%SK PP need files and script, table of event rates and errors
