...
Bruno Pontecorvo proposed a solution in 1968 \cite{pontecorvo}, which involved neutrinos changing flavour as they propagated through space. This phenomenon, known as neutrino oscillations, was similar to the CKM \cite{CKM} \cite{CKM2} formalism of quark mixing. Some of the electron neutrinos produced in the Sun would therefore change flavour before reaching the Earth, causing the flux deficits measured. However, this required neutrinos to have mass, which would be significant modification to the Standard Model of particle physics. The success of the massless theory of the neutrino meant that this explanation initially did not gain much support.
