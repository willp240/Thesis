#!/bin/bash
throwspath="/vols/t2k/users/wparker2/Throws2020_v2r39/"
outputpath="/vols/t2k/users/wparker2/NIWGReWeights2020_v2r39/"
executable="genWeightFromPsycheRunSyst_new2020.exe"
count=0
MAXJOBS=400
...
do
    ...
    infile=${throwspath}/${run}/root/${run}_FlatTree_v2r39_11_18_${i}_12_14_Throws.root
    outfile=${outdir}/${run}NIWGWeights_${i}.root
	...
	then
	    ...
	    echo "source /vols/build/t2k/wparker2/neut-OA2020Development_2/neut-OA2020Development/build/Linux/setup.sh" >> $ScriptFileName
	    echo "cd /vols/build/t2k/wparker2/T2KReWeight/" >> $ScriptFileName
	    echo "source edssetup.sh" >> $ScriptFileName
	    echo "source example_config.sh" >> $ScriptFileName
	    echo "cd app" >> $ScriptFileName
...
#             echo "source /vols/build/t2k/wparker2/ROOT/v5r34p34n00/Linux-x86_64/bin/thisroot.sh" >>$ScriptFileName
