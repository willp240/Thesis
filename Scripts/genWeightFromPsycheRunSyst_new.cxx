...
void ReweightTree(){
  ...
  //rw.Systematics().Include(t2krew::kNXSec_MaNFFRES);//WP gone, any mares ?
  rw.Systematics().Include(t2krew::kNXSec_BgSclRES);
  rw.Systematics().Include(t2krew::kNXSec_BgSclRESLowMPI);//WP check name
  ...
  rw.Systematics().Include(t2krew::kNIWGCC_BY_DIS);
  rw.Systematics().Include(t2krew::kNIWGCC_BY_MultPi);
  rw.Systematics().Include(t2krew::kNIWGCC_AGKY_MultPi);
  ...
  rw.Systematics().Include(t2krew::kNIWGMEC_Nu_High);//WP Check Names
  rw.Systematics().Include(t2krew::kNIWGMEC_Nubar_High);
  rw.Systematics().Include(t2krew::kNIWGMEC_Nu_Low);
  rw.Systematics().Include(t2krew::kNIWGMEC_Nubar_Low);
  //WP add Q2 ?
  ...
  dials.push_bacl(t2krew::kNXSec_BgSclLMCPiBarRES);//WP checkname
  ...
  dials.push_back(t2krew::kNIWGCC_BY_DIS);//WP check name
  dials.push_back(t2krew::kNIWGCC_BY_MultPi);//WP check name
  dials.push_back(t2krew::kNIWGCC_AGKY_MultPi);//WP check name
  ...
  // dials.push_back(t2krew::kNIWG2014a_SF_RFG);//WP gone
  ...
  rw.Systematics().SetAbsTwk(t2krew::kNXSec_BgSclLMCPiBarRES);
  ...
  //WP check this
  rw.Systematics().SetTwkDial(t2krew::kNIWG_rpaCCQE_norm, 1);//WP should these be gone? 
  rw.Systematics().SetTwkDial(t2krew::kNIWG_rpaCCQE_shape,0);

  //WP Iso1/2, CA5, MaRES all different from neut nominal. 
  //WP Q2 also different but norms ?
